<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:86:"D:\phpStudy\PHPTutorial\WWW\easyadmin\public/../application/index\view\user\login.html";i:1547180038;s:80:"D:\phpStudy\PHPTutorial\WWW\easyadmin\application\index\view\layout\default.html";i:1547180038;s:77:"D:\phpStudy\PHPTutorial\WWW\easyadmin\application\index\view\common\meta.html";i:1547180038;s:79:"D:\phpStudy\PHPTutorial\WWW\easyadmin\application\index\view\common\script.html";i:1547180038;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<link href="/easyadmin/public/assets/css/frontend<?php echo \think\Config::get('app_debug')?'':'.min'; ?>.css?v=<?php echo \think\Config::get('site.version'); ?>" rel="stylesheet">
...
<script type="text/javascript">
    var require = {
        ...
        <link href="/easyadmin/public/assets/css/user.css?v=<?php echo \think\Config::get('site.version'); ?>" rel="stylesheet">
    </head>
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo url('/'); ?>" style="padding:6px 15px;"><img src="/easyadmin/public/assets/img/logo.png" style="height:40px;" alt=""></a>
                </div>
...
<script type="text/html" id="resetpwdtpl">
    <form id="resetpwd-form" class="form-horizontal form-layer" method="POST" action="<?php echo url('api/user/resetpwd'); ?>">
        ...
        <script src="/easyadmin/public/assets/js/require<?php echo \think\Config::get('app_debug')?'':'.min'; ?>.js" data-main="/easyadmin/public/assets/js/require-frontend<?php echo \think\Config::get('app_debug')?'':'.min'; ?>.js?v=<?php echo $site['version']; ?>"></script>
