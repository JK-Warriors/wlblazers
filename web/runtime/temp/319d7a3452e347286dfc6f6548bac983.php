<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:90:"D:\workspace\github\repository\ywy_admin\public/../application/admin\view\index\login.html";i:1547180037;s:80:"D:\workspace\github\repository\ywy_admin\application\admin\view\common\meta.html";i:1547180037;s:82:"D:\workspace\github\repository\ywy_admin\application\admin\view\common\script.html";i:1547180037;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
                            ...
                            <form action="" method="post" id="login-form">
                                ...
                                <div class="input-group">
                                    ...
                                    <span class="input-group-addon" style="padding:0;border:none;cursor:pointer;">
                                        <img src="<?php echo rtrim('/', '/'); ?>/index.php/captcha" width="100" height="30" onclick="this.src = '<?php echo rtrim('/', '/'); ?>/index.php/captcha?r=' + Math.random();"/>
                                    </span>
                                </div>
                                <?php endif; ?>
